    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                ...
                description:
                    'A autenticação em dois fatores está ativada. Escaneie o QR code ou insira a chave de configuração no seu aplicativo autenticador.',
                buttonText: 'Fechar',
            };
        }
        ...
        return {
            ...
            description:
                'Para concluir a ativação, escaneie o QR code ou insira a chave de configuração no seu aplicativo autenticador',
            buttonText: 'Continuar',
        };
